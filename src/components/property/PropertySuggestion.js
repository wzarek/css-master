...
const PropertySuggestion = (props) => {
  return (
    <div className='mx-1 my-1 border-2 border-black relative group overflow-hidden'>  
          ...
          <h3 className='text-center text-black absolute bottom-0 left-0 w-full bg-slate-500 bg-opacity-70 backdrop-blur-sm p-1 duration-300 group-hover:p-5'>{props?.name}</h3>
    </div>
  )
}
